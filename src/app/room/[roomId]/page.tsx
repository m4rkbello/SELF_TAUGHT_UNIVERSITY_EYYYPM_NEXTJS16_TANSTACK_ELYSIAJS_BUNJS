            ...
            <div className="flex gap-4">
                <div className="flex-1 relative group">
                    ...
                    <span className="absolute left-4 top-1/2 -translate-y-1/2 text-green-500 animate-pulse">
                        {">"}
                        <input type="text" className="w-full bg-black border border-zinc-800 focus-border-700 focus-outline-none transition-colors text-zinc-100 placeholder:text-zinc-700" />
                    </span>
