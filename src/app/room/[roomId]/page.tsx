...
const Page = () => {
    ...
    return <main className="flex flex-col h-screen max-h-screen overflow-hidden">
        <header className="border-b border-zinc-800 p-4 flex-center items-center justify-between bg-zinc-900/30">
        ...
        <div className="p-4 border-t border-zinc-800 bg-zinc-900/30">
            <div className="flex gap-4">
                ...
                <button className="bg-zinc-800 text-zinc-400 px-6 tex-sm font-bold hover:text-zinc-200 transition-all disable:opacity-50 disable:cursor-not-allowed cursor-pointer">SEND</button>
            </div>
        </div>
